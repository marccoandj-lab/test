...
export const financeUljezSets: UljezSet[] = [
  { theme: { en: "Banking Services", sr: "Bankarske usluge" }, options: { en: ["ATM", "Loan", "Savings", "Telescope"], sr: ["Bankomat", "Kredit", "Štednja", "Teleskop"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A telescope is a scientific instrument, not a banking service.", sr: "Teleskop je naučni instrument, a ne bankarska usluga." } },
  { theme: { en: "Currencies", sr: "Valute" }, options: { en: ["Dollar", "Euro", "Yen", "Ounce"], sr: ["Dolar", "Evro", "Jen", "Unca"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "An ounce is a unit of weight, not a currency.", sr: "Unca je jedinica mase, a ne valuta." } },
  { theme: { en: "Investments", sr: "Investicije" }, options: { en: ["Stocks", "Bonds", "Real Estate", "Ticket"], sr: ["Akcije", "Obveznice", "Nekretnine", "Ulaznica"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A ticket is for an event or travel, not a financial investment.", sr: "Ulaznica je za događaj ili putovanje, a ne finansijska investicija." } },
  { theme: { en: "Expenses", sr: "Troškovi" }, options: { en: ["Rent", "Utilities", "Groceries", "Gift card"], sr: ["Kirija", "Komunalije", "Namirnice", "Poklon kartica"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A gift card is a form of payment or asset, not a regular monthly expense.", sr: "Poklon kartica je sredstvo plaćanja ili imovina, a ne redovni mesečni trošak." } },
  { theme: { en: "Income", sr: "Prihodi" }, options: { en: ["Salary", "Bonus", "Dividends", "Tax"], sr: ["Plata", "Bonus", "Dividende", "Porez"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "Tax is an expense paid to the government, not a form of income.", sr: "Porez je trošak koji se plaća državi, a ne izvor prihoda." } },
  { theme: { en: "Payment Methods", sr: "Načini plaćanja" }, options: { en: ["Credit Card", "Cash", "Wire Transfer", "Stamp"], sr: ["Kreditna kartica", "Keš", "Prenos sredstava", "Pečat"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A stamp is used for postage, not as a method of financial payment.", sr: "Pečat se koristi za poštu, a ne kao metod finansijskog plaćanja." } },
  { theme: { en: "Financial Documents", sr: "Finansijska dokumenta" }, options: { en: ["Invoice", "Receipt", "Balance Sheet", "Novel"], sr: ["Faktura", "Priznanica", "Bilans stanja", "Roman"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A novel is a work of fiction, not a financial or business document.", sr: "Roman je književno delo, a ne finansijski ili poslovni dokument." } },
  { theme: { en: "Stock Market terms", sr: "Berzanski termini" }, options: { en: ["Bull", "Bear", "IPO", "Zoo"], sr: ["Bul", "Ber", "IPO", "Zoološki vrt"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A zoo is a place for animals, not a term used in stock market trading.", sr: "Zoološki vrt je mesto za životinje, a ne termin koji se koristi u trgovini na berzi." } },
  { theme: { en: "Taxes", sr: "Porezi" }, options: { en: ["VAT", "Income Tax", "Property Tax", "Subscription"], sr: ["PDV", "Porez na dohodak", "Porez na imovinu", "Pretplata"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A subscription is a recurring payment for a service, not a government tax.", sr: "Pretplata je periodično plaćanje za uslugu, a ne državni porez." } },
  { theme: { en: "Insurance", sr: "Osiguranje" }, options: { en: ["Health", "Life", "Car", "Weather"], sr: ["Zdravstveno", "Životno", "Auto", "Vremenska prognoza"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A weather forecast predicts conditions, it is not a type of insurance policy.", sr: "Vremenska prognoza predviđa uslove, ona nije vrsta polise osiguranja." } },
  { theme: { en: "Debt", sr: "Dug" }, options: { en: ["Mortgage", "Overdraft", "Credit", "Asset"], sr: ["Hipoteka", "Pozajmica", "Kredit", "Imovina (Asset)"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "An asset is something you own, while the others are forms of debt you owe.", sr: "Imovina (asset) je nešto što posedujete, dok su ostalo oblici duga koje dugujete." } },
  { theme: { en: "Retirement", sr: "Penzionisanje" }, options: { en: ["Pension", "Annuity", "Retirement Fund", "Vacation"], sr: ["Penzija", "Anuitet", "Penzioni fond", "Odmor"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A vacation is a trip for leisure, not a financial tool for retirement.", sr: "Odmor je putovanje radi zabave, a ne finansijski instrument za penziju." } },
  { theme: { en: "Accounting", sr: "Računovodstvo" }, options: { en: ["Audit", "Ledger", "Depreciation", "Painting"], sr: ["Revizija", "Glavna knjiga", "Amortizacija", "Slika"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A painting is a piece of art, not an accounting process or document.", sr: "Slika je umetničko delo, a ne računovodstveni proces ili dokument." } },
  { theme: { en: "Crypto", sr: "Kriptovalute" }, options: { en: ["Bitcoin", "Ethereum", "Wallet", "Physical Coin"], sr: ["Bitkoin", "Eterijum", "Novčanik", "Fizički novčić"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "Cryptocurrencies are digital; a physical coin is traditional tangible currency.", sr: "Kriptovalute su digitalne; fizički novčić je tradicionalna opipljiva valuta." } },
  { theme: { en: "Business Structure", sr: "Poslovna struktura" }, options: { en: ["LLC", "Corporation", "Partnership", "Club"], sr: ["D.O.O.", "Korporacija", "Partnerstvo", "Klub"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A club is a social organization, not a legal business entity type.", sr: "Klub je društvena organizacija, a ne tip pravnog poslovnog subjekta." } },
  { theme: { en: "Market Indicators", sr: "Tržišni indikatori" }, options: { en: ["GDP", "Inflation", "Unemployment", "Forecast"], sr: ["BDP", "Inflacija", "Nezaposlenost", "Vremenska prognoza"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A weather forecast is meteorological, while the others are economic indicators.", sr: "Vremenska prognoza je meteorološka, dok su ostalo ekonomski indikatori." } },
  { theme: { en: "Banking Roles", sr: "Bankarske uloge" }, options: { en: ["Teller", "Auditor", "Loan Officer", "Waiter"], sr: ["Blagajnik", "Revizor", "Kreditni službenik", "Konobar"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A waiter works in the hospitality industry, not in a bank.", sr: "Konobar radi u ugostiteljstvu, a ne u banci." } },
  { theme: { en: "E-banking", sr: "E-bankarstvo" }, options: { en: ["2FA", "QR Code", "IBAN", "Fax"], sr: ["2FA", "QR Kod", "IBAN", "Faks"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A fax machine is an outdated analog communication tool, not a modern e-banking feature.", sr: "Faks mašina je zastareli analogni alat za komunikaciju, a ne moderna funkcija e-bankarstva." } },
  { theme: { en: "Commodities", sr: "Roba/Commodities" }, options: { en: ["Gold", "Oil", "Wheat", "Smartphone"], sr: ["Zlato", "Nafta", "Pšenica", "Pametni telefon"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A smartphone is a finished consumer product, not a raw commodity.", sr: "Pametni telefon je gotov potrošački proizvod, a ne osnovna sirovina (roba)." } },
  { theme: { en: "Risk", sr: "Rizik" }, options: { en: ["Default", "Volatility", "Liquidity", "Certainty"], sr: ["Neizmirivanje obaveza", "Volatilnost", "Likvidnost", "Sigurnost"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "Certainty means no risk, while the other terms describe various types of financial risk.", sr: "Sigurnost (certainty) znači odsustvo rizika, dok ostali termini opisuju razne vrste finansijskog rizika." } },
  { theme: { en: "Financial Institutions", sr: "Finansijske institucije" }, options: { en: ["Central Bank", "Brokerage", "Credit Union", "Museum"], sr: ["Centralna banka", "Brokerska kuća", "Kreditna unija", "Muzej"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A museum is a cultural institution, not a financial one.", sr: "Muzej je kulturna institucija, a ne finansijska." } },
  { theme: { en: "Budgeting", sr: "Budžetiranje" }, options: { en: ["Forecast", "Surplus", "Deficit", "Hobby"], sr: ["Prognoza", "Suficit", "Deficit", "Hobi"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A hobby is a personal interest, not a term related to financial budgeting.", sr: "Hobi je lično interesovanje, a ne termin vezan za finansijsko budžetiranje." } },
  { theme: { en: "Pricing", sr: "Određivanje cena" }, options: { en: ["Discount", "Wholesale", "Retail", "Free"], sr: ["Popust", "Veleprodaja", "Maloprodaja", "Besplatno"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "'Free' means no price is charged, while the others are methods or levels of pricing.", sr: "'Besplatno' znači da se cena ne naplaćuje, dok su ostalo metodi ili nivoi određivanja cena." } },
  { theme: { en: "Lending", sr: "Pozajmljivanje" }, options: { en: ["Principal", "Interest", "Collateral", "Donation"], sr: ["Glavnica", "Kamata", "Kolateral", "Donacija"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A donation is a gift with no repayment expected, unlike a loan.", sr: "Donacija je poklon bez očekivanja otplate, za razliku od kredita." } },
  { theme: { en: "Assets", sr: "Imovina (Assets)" }, options: { en: ["Cash", "Inventory", "Equipment", "Liabilities"], sr: ["Keš", "Zalihe", "Oprema", "Obaveze (Liabilities)"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "Liabilities are what you owe, while assets are what you own.", sr: "Obaveze (liabilities) su ono što dugujete, dok je imovina ono što posedujete." } },
  { theme: { en: "Savings", sr: "Štednja" }, options: { en: ["Emergency Fund", "Deposit", "Piggy bank", "Credit Card"], sr: ["Fond za hitne slučajeve", "Depozit", "Kasica prasica", "Kreditna kartica"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "A credit card is a tool for spending borrowed money, not for saving.", sr: "Kreditna kartica je alat za trošenje pozajmljenog novca, a ne za štednju." } },
  { theme: { en: "Financial Crime", sr: "Finansijski kriminal" }, options: { en: ["Fraud", "Money Laundering", "Embezzlement", "Charity"], sr: ["Prevara", "Pranje novca", "Pronevera", "Humanitarna pomoć"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "Charity is a helpful organization, while the others are types of financial crimes.", sr: "Humanitarna pomoć je plemenita aktivnost, dok su ostalo vrste finansijskog kriminala." } },
  { theme: { en: "Trading", sr: "Trgovanje" }, options: { en: ["Arbitrage", "Day trading", "Leverage", "Gambling"], sr: ["Arbitraža", "Dnevno trgovanje", "Leveridž", "Kockanje"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "Gambling is based purely on chance, unlike financial trading strategies.", sr: "Kockanje se zasniva isključivo na sreći, za razliku od strategija finansijskog trgovanja." } },
  { theme: { en: "Financial Software", sr: "Finansijski softver" }, options: { en: ["Excel", "SAP", "QuickBooks", "Photoshop"], sr: ["Excel", "SAP", "QuickBooks", "Photoshop"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "Photoshop is for image editing, while the others are used for financial analysis and accounting.", sr: "Photoshop je za obradu slika, dok se ostali koriste za finansijsku analizu i računovodstvo." } },
  { theme: { en: "Growth", sr: "Rast" }, options: { en: ["Compound Interest", "Scaling", "Expansion", "Bankruptcy"], sr: ["Složena kamata", "Skaliranje", "Ekspanzija", "Bankrot"] }, correct: 3, mode: 'finance', reward: 25000, penalty: 12500, explanation: { en: "Bankruptcy is the failure of a business, while the other terms describe business growth.", sr: "Bankrot je propast poslovanja, dok ostali termini opisuju rast biznisa." } }
];

export const sustainabilityUljezSets: UljezSet[] = [
  { theme: { en: "Renewable Energy", sr: "Obnovljiva energija" }, options: { en: ["Solar", "Wind", "Hydro", "Coal"], sr: ["Solarna", "Vetro", "Hidro", "Ugalj"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Coal is a fossil fuel and a non-renewable energy source.", sr: "Ugalj je fosilno gorivo i neobnovljiv izvor energije." } },
  { theme: { en: "Waste Management", sr: "Upravljanje otpadom" }, options: { en: ["Recycling", "Composting", "Reuse", "Littering"], sr: ["Reciklaža", "Kompostiranje", "Ponovna upotreba", "Bacanje smeća"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Littering is the improper disposal of waste, unlike the other sustainable practices.", sr: "Bacanje smeća je nepravilno odlaganje otpada, za razliku od ostalih održivih praksi." } },
  { theme: { en: "Pollutants", sr: "Zagađivači" }, options: { en: ["CO2", "Methane", "Plastic", "Oxygen"], sr: ["CO2", "Metan", "Plastika", "Kiseonik"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Oxygen is vital for life and not an environmental pollutant.", sr: "Kiseonik je vitalan za život i nije zagađivač životne sredine." } },
  { theme: { en: "Ecosystems", sr: "Ekosistemi" }, options: { en: ["Rainforest", "Coral Reef", "Wetlands", "Parking Lot"], sr: ["Prašuma", "Koralni greben", "Močvara", "Parking"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "A parking lot is a man-made paved area, not a natural ecosystem.", sr: "Parking je veštačka betonirana površina, a ne prirodni ekosistem." } },
  { theme: { en: "Green Transport", sr: "Zeleni transport" }, options: { en: ["Electric Bike", "Train", "Carpool", "Private Jet"], sr: ["Električni bicikl", "Voz", "Carpool", "Privatni džet"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Private jets have extremely high carbon emissions per passenger.", sr: "Privatni džetovi imaju ekstremno visoke emisije ugljenika po putniku." } },
  { theme: { en: "Sustainable Materials", sr: "Održivi materijali" }, options: { en: ["Bamboo", "Hemp", "Recycled Glass", "Styrofoam"], sr: ["Bambus", "Konoplja", "Reciklirano staklo", "Stiropor"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Styrofoam is non-biodegradable and difficult to recycle, unlike the other materials.", sr: "Stiropor nije biorazgradiv i teško se reciklira, za razliku od ostalih materijala." } },
  { theme: { en: "Biodiversity", sr: "Biodiverzitet" }, options: { en: ["Flora", "Fauna", "Genetic diversity", "Monoculture"], sr: ["Flora", "Fauna", "Genetski diverzitet", "Monokultura"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Monoculture is the cultivation of a single crop, which reduces biodiversity.", sr: "Monokultura je uzgoj samo jedne vrste, što smanjuje biodiverzitet." } },
  { theme: { en: "Climate Change", sr: "Klimatske promene" }, options: { en: ["Global Warming", "Melting Glaciers", "Sea Level Rise", "Stable Seasons"], sr: ["Globalno zagrevanje", "Topljenje glečera", "Porast nivoa mora", "Stabilna godišnja doba"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Climate change causes unstable and extreme weather, not stable seasons.", sr: "Klimatske promene uzrokuju nestabilna i ekstremna vremena, a ne stabilna godišnja doba." } },
  { theme: { en: "Conservation", sr: "Očuvanje prirode" }, options: { en: ["Reforestation", "Wildlife Protection", "Water Saving", "Deforestation"], sr: ["Pošumljavanje", "Zaštita divljih životinja", "Ušteda vode", "Deforestacija"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Deforestation is the destruction of forests, which is the opposite of conservation.", sr: "Deforestacija je uništavanje šuma, što je suprotno od očuvanja prirode." } },
  { theme: { en: "Organic Farming", sr: "Organska poljoprivreda" }, options: { en: ["No Pesticides", "Crop Rotation", "Natural Fertilizer", "GMO"], sr: ["Bez pesticida", "Plodored", "Prirodno đubrivo", "GMO"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Genetically Modified Organisms (GMOs) are generally not permitted in organic farming.", sr: "Genetski modifikovani organizmi (GMO) generalno nisu dozvoljeni u organskoj poljoprivredi." } },
  { theme: { en: "Urban Ecology", sr: "Urbana ekologija" }, options: { en: ["Green Roofs", "Vertical Gardens", "Bike Lanes", "Highway"], sr: ["Zeleni krovovi", "Vertikalne bašte", "Biciklističke staze", "Auto-put"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Highways prioritize car traffic over green urban spaces and sustainable transport.", sr: "Auto-putevi daju prednost automobilskom saobraćaju u odnosu na zelene urbane prostore i održivi transport." } },
  { theme: { en: "Water Sources", sr: "Izvori vode" }, options: { en: ["Aquifer", "River", "Rainwater", "Oil Well"], sr: ["Akvifer", "Reka", "Kišnica", "Naftna bušotina"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "An oil well is used to extract fossil fuels, not to provide water.", sr: "Naftna bušotina služi za vađenje fosilnih goriva, a ne za snabdevanje vodom." } },
  { theme: { en: "Sustainable Fashion", sr: "Održiva moda" }, options: { en: ["Slow Fashion", "Upcycling", "Ethical Labor", "Fast Fashion"], sr: ["Spora moda", "Ap-sajkling", "Etički rad", "Brza moda"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Fast fashion is based on rapid production and high waste, which is unsustainable.", sr: "Brza moda se zasniva na brzoj proizvodnji i velikom otpadu, što je neodrživo." } },
  { theme: { en: "Eco-friendly Habits", sr: "Ekološke navike" }, options: { en: ["Meatless Monday", "Zero Waste", "Second-hand", "Overconsumption"], sr: ["Ponedeljak bez mesa", "Zero Waste", "Second-hand", "Prekomerna potrošnja"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Overconsumption leads to excessive waste and resource depletion.", sr: "Prekomerna potrošnja vodi ka prevelikom otpadu i iscrpljivanju resursa." } },
  { theme: { en: "Natural Resources", sr: "Prirodni resursi" }, options: { en: ["Sunlight", "Wind", "Tides", "Natural Gas"], sr: ["Sunčeva svetlost", "Vetar", "Plima", "Prirodni gas"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Natural gas is a finite fossil fuel, unlike the other infinite renewable resources.", sr: "Prirodni gas je ograničeno fosilno gorivo, za razliku od ostalih beskonačnih obnovljivih resursa." } },
  { theme: { en: "Endangered Species", sr: "Ugrožene vrste" }, options: { en: ["Panda", "Blue Whale", "Snow Leopard", "Pigeon"], sr: ["Panda", "Plavi kit", "Snežni leopard", "Golub"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Pigeons are very common and not considered an endangered species.", sr: "Golubovi su veoma česti i ne smatraju se ugroženom vrstom." } },
  { theme: { en: "Green Tech", sr: "Zelena tehnologija" }, options: { en: ["Smart Grid", "Energy Storage", "Carbon Capture", "Internal Combustion"], sr: ["Pametna mreža", "Skladištenje energije", "Hvatanje ugljenika", "Unutrašnje sagorevanje"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Internal combustion engines typically run on fossil fuels and produce high emissions.", sr: "Motori sa unutrašnjim sagorevanjem obično rade na fosilna goriva i proizvode velike emisije." } },
  { theme: { en: "Forest types", sr: "Tipovi šuma" }, options: { en: ["Deciduous", "Coniferous", "Tropical", "Concrete Jungle"], sr: ["Listopadna", "Četinarska", "Tropska", "Betonska džungla"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "A 'concrete jungle' is a metaphor for a dense city, not a biological forest type.", sr: "'Betonska džungla' je metafora za gust grad, a ne biološki tip šume." } },
  { theme: { en: "Sustainable Business", sr: "Održivo poslovanje" }, options: { en: ["B-Corp", "Circular Economy", "Fair Trade", "Monopoly"], sr: ["B-Corp", "Cirkularna ekonomija", "Fair Trade", "Monopol"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "A monopoly is a market structure that limits competition and is not a sustainability model.", sr: "Monopol je tržišna struktura koja ograničava konkurenciju i nije model održivosti." } },
  { theme: { en: "Atmospheric layers", sr: "Atmosferski slojevi" }, options: { en: ["Troposphere", "Stratosphere", "Mesosphere", "Hydrosphere"], sr: ["Troposfera", "Stratosfera", "Mezosfera", "Hidrosfera"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "The hydrosphere refers to all water on Earth, not a layer of the atmosphere.", sr: "Hidrosfera se odnosi na svu vodu na Zemlji, a ne na sloj atmosfere." } },
  { theme: { en: "Soil health", sr: "Zdravlje zemljišta" }, options: { en: ["Humus", "Microorganisms", "Nutrients", "Salinity"], sr: ["Humus", "Mikroorganizmi", "Nutrijenti", "Salinitet"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "High salinity is harmful to most plants and soil health.", sr: "Visok salinitet je štetan za većinu biljaka i zdravlje zemljišta." } },
  { theme: { en: "Green Buildings", sr: "Zelene zgrade" }, options: { en: ["Insulation", "Double glazing", "Solar panels", "Single-pane windows"], sr: ["Izolacija", "Duplo staklo", "Solarni paneli", "Jednostruko staklo"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Single-pane windows have poor insulation, leading to significant energy loss.", sr: "Jednostruka stakla imaju lošu izolaciju, što dovodi do velikog gubitka energije." } },
  { theme: { en: "Ocean Health", sr: "Zdravlje okeana" }, options: { en: ["Plankton", "Seagrass", "Kelp", "Oil Spill"], sr: ["Plankton", "Morska trava", "Kelp", "Izlivanje nafte"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "An oil spill is a major environmental disaster that severely harms ocean life.", sr: "Izlivanje nafte je velika ekološka katastrofa koja teško šteti životu u okeanu." } },
  { theme: { en: "Sustainable Tourism", sr: "Održivi turizam" }, options: { en: ["Ecotourism", "Local Stays", "Leave No Trace", "Cruise Ships"], sr: ["Ekoturizam", "Lokalni smeštaj", "Ne ostavljaj trag", "Kruzeri"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Large cruise ships have a massive environmental impact on oceans and coastal areas.", sr: "Veliki kruzeri imaju ogroman uticaj na životnu sredinu, okeane i priobalne oblasti." } },
  { theme: { en: "Environmental Policy", sr: "Ekološka politika" }, options: { en: ["Paris Agreement", "Carbon Tax", "Emissions Trading", "Deregulation"], sr: ["Pariski sporazum", "Porez na ugljenik", "Trgovina emisijama", "Deregulacija"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Deregulation often removes environmental protections, unlike proactive policies.", sr: "Deregulacija često uklanja ekološke zaštite, za razliku od proaktivnih politika." } },
  { theme: { en: "Alternative Fuels", sr: "Alternativna goriva" }, options: { en: ["Biofuel", "Hydrogen", "Electricity", "Diesel"], sr: ["Biogorivo", "Vodonik", "Struja", "Dizel"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Diesel is a traditional fossil fuel, unlike the other cleaner alternatives.", sr: "Dizel je tradicionalno fosilno gorivo, za razliku od ostalih čistijih alternativa." } },
  { theme: { en: "Sustainable Forestry", sr: "Održivo šumarstvo" }, options: { en: ["Selective Logging", "FSC Certified", "Tree Planting", "Clear-cutting"], sr: ["Selektivna seča", "FSC sertifikovano", "Sadnja drveća", "Seča do gole zemlje"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Clear-cutting involves removing all trees in an area, which destroys the forest ecosystem.", sr: "Seča do gole zemlje podrazumeva uklanjanje svih stabala, što uništava šumski ekosistem." } },
  { theme: { en: "Environmental Metrics", sr: "Ekološki pokazatelji" }, options: { en: ["Carbon Footprint", "Water Footprint", "Ecological Footprint", "Profit Margin"], sr: ["Karbonski otisak", "Vodeni otisak", "Ekološki otisak", "Profitna marža"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Profit margin is a financial metric, while the others measure environmental impact.", sr: "Profitna marža je finansijski pokazatelj, dok ostali mere uticaj na životnu sredinu." } },
  { theme: { en: "Compostable Items", sr: "Kompostabilni predmeti" }, options: { en: ["Banana peel", "Eggshells", "Cardboard", "Plastic bottle"], sr: ["Kora banane", "Ljuske jaja", "Karton", "Plastična flaša"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "Standard plastic bottles take hundreds of years to decompose and are not compostable.", sr: "Standardne plastične flaše se razlažu stotinama godina i ne mogu se kompostirati." } },
  { theme: { en: "Eco Symbols", sr: "Ekološki simboli" }, options: { en: ["Mobius Loop", "Green Dot", "Leaping Bunny", "Skull and Crossbones"], sr: ["Mebijusova petlja", "Zelena tačka", "Zeka (Cruelty Free)", "Mrtvačka glava"] }, correct: 3, mode: 'sustainability', reward: 25000, penalty: 12500, explanation: { en: "A skull and crossbones is a symbol for poison or danger, not an ecological label.", sr: "Mrtvačka glava je simbol za otrov ili opasnost, a ne ekološka oznaka." } }
];
